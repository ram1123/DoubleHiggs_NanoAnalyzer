...
// Wed Oct  7 10:53:06 2020 by ROOT version 6.12/07
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Float_t         TkMET_sumEt;
   UInt_t          nTrigObj;
   Float_t         TrigObj_pt[41];   //[nTrigObj]
   Float_t         TrigObj_eta[41];   //[nTrigObj]
   Float_t         TrigObj_phi[41];   //[nTrigObj]
   Float_t         TrigObj_l1pt[41];   //[nTrigObj]
   Float_t         TrigObj_l1pt_2[41];   //[nTrigObj]
   Float_t         TrigObj_l2pt[41];   //[nTrigObj]
   Int_t           TrigObj_id[41];   //[nTrigObj]
   Int_t           TrigObj_l1iso[41];   //[nTrigObj]
   Int_t           TrigObj_l1charge[41];   //[nTrigObj]
   Int_t           TrigObj_filterBits[41];   //[nTrigObj]
   UInt_t          nOtherPV;
   ...
   NanoAOD_Data(TTree *tree) : fChain(0)
   {
      if (tree == 0) {
...
// void NanoAOD_Data::Show(Long64_t entry)
// {
...
//    fChain->Show(entry);
// }
// Int_t NanoAOD_Data::Cut(Long64_t entry)
// {
