...
// Tue Oct  6 15:37:05 2020 by ROOT version 6.12/07
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   UInt_t          nGenPart;
   Float_t         GenPart_eta[170];   //[nGenPart]
   Float_t         GenPart_mass[170];   //[nGenPart]
   Float_t         GenPart_phi[170];   //[nGenPart]
   Float_t         GenPart_pt[170];   //[nGenPart]
   Int_t           GenPart_genPartIdxMother[170];   //[nGenPart]
   Int_t           GenPart_pdgId[170];   //[nGenPart]
   Int_t           GenPart_status[170];   //[nGenPart]
   Int_t           GenPart_statusFlags[170];   //[nGenPart]
   ...
   Float_t         FatJet_pt_jesTimeRunDEUp[7];   //[nFatJet]
   Float_t         FatJet_mass_jesTimeRunDEUp[7];   //[nFatJet]
   Float_t         FatJet_msoftdrop_jesTimeRunDEUp[7];   //[nFatJet]
   Float_t         FatJet_pt_jesTimeRunFUp[7];   //[nFatJet]
   Float_t         FatJet_mass_jesTimeRunFUp[7];   //[nFatJet]
   Float_t         FatJet_msoftdrop_jesTimeRunFUp[7];   //[nFatJet]
   ...
   Float_t         FatJet_pt_jesTimeRunDEDown[7];   //[nFatJet]
   Float_t         FatJet_mass_jesTimeRunDEDown[7];   //[nFatJet]
   Float_t         FatJet_msoftdrop_jesTimeRunDEDown[7];   //[nFatJet]
   Float_t         FatJet_pt_jesTimeRunFDown[7];   //[nFatJet]
   Float_t         FatJet_mass_jesTimeRunFDown[7];   //[nFatJet]
   Float_t         FatJet_msoftdrop_jesTimeRunFDown[7];   //[nFatJet]
