...
// Mon Nov  1 15:29:51 2021 by ROOT version 6.14/09
// from TTree Events/Events
// found on file: CDCFA813-DAD0-F545-9930-930F1575D1F6.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   UInt_t          nGenPart;
   Float_t         GenPart_eta[106];   //[nGenPart]
   Float_t         GenPart_mass[106];   //[nGenPart]
   Float_t         GenPart_phi[106];   //[nGenPart]
   Float_t         GenPart_pt[106];   //[nGenPart]
   Int_t           GenPart_genPartIdxMother[106];   //[nGenPart]
   Int_t           GenPart_pdgId[106];   //[nGenPart]
   Int_t           GenPart_status[106];   //[nGenPart]
   Int_t           GenPart_statusFlags[106];   //[nGenPart]
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("CDCFA813-DAD0-F545-9930-930F1575D1F6.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("CDCFA813-DAD0-F545-9930-930F1575D1F6.root");
      }
